...
# 2 "<built-in>" 2
# 1 "Codigo_Pr5_Parte2.c" 2
# 11 "Codigo_Pr5_Parte2.c"
...
void Configacion_inicialPIC(void){
    ADCON1 = 0x0F;
    TRISD = 0x00;
    TRISAbits.TRISA1 = 0;
    TRISAbits.TRISA2 = 0;
