...
void ActualizarDisplays(void){
    if (modo_display){
        ...
        datos[0] = codigosNum[Hora / 10];
        datos[1] = codigosNum[Hora % 10];
        datos[2] = codigosNum[Minutos / 10];
        datos[3] = codigosNum[Minutos % 10];
...
# 273 "Pr4_Parte2.c"
        ...
        LATD = (datos[multiplex] & 0xFE) | (PORTDbits.RD0);
        switch(multiplex){
    ...
    while(1){
        ...
        if(cntISR >= 200){
            ...
            if(!reloj_activo){
                ...
                if(MedioSecCount == 0) cuenta_Minutos++;
        ...
        if(tecla == 10 && !reloj_activo){
            ...
            if(btn_A_cnt == 1){
                ...
                ActualizarDisplays();
                DelayXms(2000);
                modo_display = 0; Hora = 0; Minutos = 0;
                ActualizarDisplays();
                ing_btn_A = 1;
            }
        } else {
        ...
        if(tecla == 11 && !reloj_activo && ing_btn_A){
            btn_B_cnt++;
            if(btn_B_cnt == 1){
                Buzzer();
                IncrementarTiempo();
...
# 457 "Pr4_Parte2.c"
        if(tecla == 12 && !reloj_activo && ing_btn_A){
            btn_C_cnt++;
            if(btn_C_cnt == 1){
                Buzzer();
                DecrementarTiempo();
        ...
        if(tecla == 13 && !reloj_activo && ing_btn_A){
            btn_D_cnt++;
            if(btn_D_cnt == 1){
                Buzzer(); reloj_activo = 1;
                cuenta_Minutos = 0; cntISR = 0;
                ActualizarDisplays();
            }
        } else {
            btn_D_cnt = 0;
