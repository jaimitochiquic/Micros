...
# 2 "<built-in>" 2
# 1 "Codigo_Pr5_Parte4.c" 2
# 10 "Codigo_Pr5_Parte4.c"
...
# 74 "Codigo_Pr5_Parte4.c" 2
# 85 "Codigo_Pr5_Parte4.c"
volatile unsigned int adcValue = 0;
unsigned char temp = 0;
volatile unsigned int ledPeriodo = 25;
volatile unsigned char flagADC = 0;

volatile unsigned char modo = 3;
volatile unsigned char holdADC = 0;
volatile unsigned int ledManual = 100;
volatile unsigned int puntaje = 0;
...
void __attribute__((picinterrupt(("high_priority")))) InterrupcionHP(void) {
