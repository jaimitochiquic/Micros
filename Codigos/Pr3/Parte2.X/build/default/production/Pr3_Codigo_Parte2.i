...
# 2 "<built-in>" 2
# 1 "Pr3_Codigo_Parte2.c" 2
# 13 "Pr3_Codigo_Parte2.c"
...
volatile unsigned char visDisplay = 1;
...
void main(void){
    ...
    LATCbits.LATC1 = 0;
    LATCbits.LATC0 = 0;
# 223 "Pr3_Codigo_Parte2.c"
    TMR0H = 0xF1;
    TMR0L = 0x5A;
    T0CON = 0b00000010;
# 235 "Pr3_Codigo_Parte2.c"
    RCONbits.IPEN = 1;
