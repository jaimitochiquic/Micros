...
unsigned char Seg_Micro = 0;
unsigned char Min_Micro = 0;
char op_Micro = 0;
char ing_micro = 0;
char reloj_no_configurado = 1;


unsigned char bloqueo_ninos = 0;
unsigned char puerta_abierta = 0;
unsigned int timer_stop_3s = 0;
unsigned char conteo_paradas = 0;
...
void AsignarTiempoDisplay(unsigned char valor_izq, unsigned char valor_der) {
    ...
    datos[0] = codigosNum[valor_izq / 10];
    datos[1] = codigosNum[valor_izq % 10];
    datos[2] = codigosNum[valor_der / 10];
    datos[3] = codigosNum[valor_der % 10];
}
