/*
 * File:   Codigo_Pr5_Parte2.c
 * Author: JAIME CHIQUI
 * Created on 16 de junio de 2026, 14:32
 */
//  PRACTICA 5 - PARTE 2: Mostrar Mensajes LCD 16*2
...
void Configuracion_inicialPIC(void){
    ADCON1 = 0x0F;      // Todos los pines ANx como digitales
...
void InitLCD(void){
    ...
    LCD_Comando(0x06);   // Incremento cursor
...
void main(void){
    ...
    while(1); // Usar TMR0 si pide por hadware, delay software
}