...
# 2 "<built-in>" 2
# 1 "Codigo_Practica6_Parte4.c" 2
# 10 "Codigo_Practica6_Parte4.c"
...
# 71 "Codigo_Practica6_Parte4.c" 2
# 81 "Codigo_Practica6_Parte4.c"
...
void BitEN(void){ LATDbits.LATD2 = 1; _delay((unsigned long)((2)*(48000000/4000000.0))); LATDbits.LATD2 = 0; _delay((unsigned long)((50)*(48000000/4000000.0))); }

void Tx_DATO(unsigned char DATO, unsigned char is_char){
    unsigned char led_state = LATD & 0x01;
    LATDbits.LATD1 = is_char; LATD = (DATO & 0xF0) | led_state; LATDbits.LATD1 = is_char; BitEN();
    LATD = ((DATO << 4) & 0xF0) | led_state; LATDbits.LATD1 = is_char; BitEN();
    _delay((unsigned long)((2)*(48000000/4000.0)));
}

void LCD_init(void){
    _delay((unsigned long)((20)*(48000000/4000.0))); LATDbits.LATD1 = 0;
    Tx_DATO(0x33, 0); Tx_DATO(0x32, 0); Tx_DATO(0x28, 0);
    Tx_DATO(0x06, 0); Tx_DATO(0x0C, 0); Tx_DATO(0x01, 0);
    _delay((unsigned long)((2)*(48000000/4000.0)));
}

void LCD_clear(void){ Tx_DATO(0x01, 0); _delay((unsigned long)((2)*(48000000/4000.0))); }
...
void main(void){
    ...
    for (char i = 0; i < 10; i++) { LATDbits.LATD0 = 1; _delay((unsigned long)((50)*(48000000/4000.0))); LATDbits.LATD0 = 0; _delay((unsigned long)((50)*(48000000/4000.0))); }
    LATDbits.LATD0 = 0;

    LCD_set_cursor(1, 2); LCD_print("Universidad de"); LCD_set_cursor(2, 6); LCD_print("Cuenca");
    _delay((unsigned long)((2000)*(48000000/4000.0))); LCD_clear(); _delay((unsigned long)((1000)*(48000000/4000.0)));

    LCD_set_cursor(1, 4); LCD_print("USART v1.0");
    _delay((unsigned long)((2000)*(48000000/4000.0))); LCD_clear(); _delay((unsigned long)((2000)*(48000000/4000.0)));
    ...
    while(1){
        ...
        if (RCIF == 1) {
            ...
            if (data == 'O' && client_state == 0) {
                ...
                for(unsigned char i = 0; i < 5; i++){ _delay((unsigned long)((1000)*(48000000/4000.0))); }
        ...
        if (tecla_actual != 255) {
            _delay((unsigned long)((30)*(48000000/4000.0)));
