...
void ActualizarDisplays(void){
    datos[0] = codigosNum[(int)digitos[0]];
    datos[1] = codigosNum[(int)digitos[1]];
    datos[2] = codigosNum[(int)digitos[2]];
    datos[3] = codigosNum[(int)digitos[3]];
}
