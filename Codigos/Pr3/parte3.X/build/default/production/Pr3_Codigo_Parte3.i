...
# 2 "<built-in>" 2
# 1 "Pr3_Codigo_Parte3.c" 2
# 14 "Pr3_Codigo_Parte3.c"
...
# 147 "Pr3_Codigo_Parte3.c"
const char mensaje[15] = {
    0b01111000,
    0b11101110,
    0b01100000,
    0b00101010,
...
# 295 "Pr3_Codigo_Parte3.c"
    ...
    datos[0] = codigosLetras[7];
    datos[1] = codigosLetras[13];
    datos[2] = codigosLetras[11];
    datos[3] = codigosLetras[0];
    visDisplay = 1;
    estadoScroll = 0;
